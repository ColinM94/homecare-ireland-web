class ClientProfile{
    ...
    static async load(clientId){  
        ...
        await ClientsDB.getClient(clientId)
            .then(client => {
                ...
                if(client.active)
                    $('#client-profile-title').html(`${client.name}`)
                else
    ...
    static async loadConns(){
        ...
        $('#datatable-client-staff').DataTable( {
            data: users,
            lengthChange: false,
            paging: false,
            bFilter: true,
            ...
            initComplete : function() {
                $('#datatable-client-staff_filter').detach().appendTo('#client-search-staff')
    ...
    static async loadVisits(){
        ...
        $('#datatable-client-visits').DataTable( {
            data: visits,
            lengthChange: false,
            paging: false,
            bFilter: true,
